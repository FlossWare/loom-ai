...
class PreflightChecker:
    ...
    def _register_defaults(self) -> None:
        ...
        github_required = os.environ.get("LOOM_REQUIRE_GITHUB", "0") == "1"
        self.register(Dependency.GH_CLI, github_required, self.check_gh_cli)
        if github_required:
    ...
    def check_gh_cli() -> PreflightResult:
        ...
        try:
            ...
            return PreflightResult(
                Dependency.GH_CLI,
                CheckStatus.FAIL if required else CheckStatus.DEGRADED,
                required,
